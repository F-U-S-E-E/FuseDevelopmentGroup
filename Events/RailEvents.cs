...
namespace RAIL.Events
{
    public static class RailEvents
    {
        public static event Action RailLoaded;
        public static event Action RailUnloaded;
        ...
        internal static void RaiseRailLoaded()
        {
            RailLoaded?.Invoke();
        }

        internal static void RaiseRailUnloaded()
        {
            RailUnloaded?.Invoke();
        }
