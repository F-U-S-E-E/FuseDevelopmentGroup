...
namespace RAIL.Data
{
    ...
    /// RAIL package. Preserved fields: id, endpoints, style, class, group,
    ...
    /// </summary>
    public sealed class RailRemovedSegmentSnapshot
    {
        public string Id { get; set; }
    ...
    /// by a RAIL package. Preserved fields: id plus upper/lower segment ids,
    ...
    /// </summary>
    public sealed class RailRemovedSpanSnapshot
    {
        public string Id { get; set; }
