...
- [x] DONE - Unity Mod Manager plugin initializes Rail.
- [x] DONE - Top-level Rail schema exists.
...
- [x] DONE - `RailLoadPriority` supported.
- [x] DONE - `RailLoadAfter` supported.
- [x] DONE - `RailLoadBefore` supported.
...
- [x] DONE - Legacy industry component aliases normalize to Rail names.
...
- [x] DONE - Rail-created station map icons are generated.
