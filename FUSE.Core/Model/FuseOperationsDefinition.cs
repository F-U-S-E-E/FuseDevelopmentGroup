...
namespace Fuse.Core.Model
{
    ...
    public sealed class FuseIndustryComponent
    {
        ...
        /// <see cref="Fuse.Core.Serialization.FuseCoreSerializer.GetSettings"/> sets
    ...
    public sealed class FuseTurntableVisuals
    {
        ...
        public FuseVector3 PitPosition { get; set; }
        public FuseVector3 PitRotation { get; set; }
        public FuseVector3 PitScale { get; set; } = FuseVector3.one;
        public string BridgeAssetIdentifier { get; set; }
        public FuseVector3 BridgePosition { get; set; }
        public FuseVector3 BridgeRotation { get; set; }
        public FuseVector3 BridgeScale { get; set; } = FuseVector3.one;
