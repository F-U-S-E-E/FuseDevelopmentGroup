...
#pragma warning restore CA1822
        ...
        public FuseVector3 Scale { get; set; } = FuseVector3.one;
    ...
    {
        public string Type { get; set; }
        public FuseVector3 Center { get; set; }
        public FuseVector3 Rotation { get; set; }
        public float? Radius { get; set; }
        public FuseVector3? Size { get; set; }
        public float? Width { get; set; }
        public FuseVector3[] Points { get; set; }
    ...
    public sealed class FuseSceneClone
    {
        ...
        public FuseVector3? LocalPosition { get; set; }
        public FuseVector3? LocalRotation { get; set; }
        public FuseVector3? LocalScale { get; set; }
    }
