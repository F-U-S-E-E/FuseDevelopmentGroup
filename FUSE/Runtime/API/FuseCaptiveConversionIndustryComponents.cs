...
namespace FUSE.Runtime.API
{
    ...
    public sealed class FuseCaptiveConversionUnloader : IndustryComponent
    {
        ...
        private string UnloadedCounterKey =>
            "fuse-captive-unloaded-" + (convertedLoad?.id ?? "load") + "-" + (subIdentifier ?? "load");
        ...
        protected override void ValidateIndustryComponent()
        {
            ...
            {
                FuseLog.Warning(
                    "FUSE captive conversion unloader has maxStorage <= 0 and will remain inert until a positive capacity is configured.");
            }
        }
    }
}
