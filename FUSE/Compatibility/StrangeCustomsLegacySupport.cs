...
namespace StrangeCustoms
{
    ...
    public class FileCache : MonoBehaviour
    {
        ...
        public class CacheEntry
        {
            ...
            internal virtual UnityEngine.Object CachedUnityObject => null;
        ...
        public class CacheEntry<T> : CacheEntry
        {
            ...
            internal override UnityEngine.Object CachedUnityObject =>
        ...
        private void Clear()
        {
            ...
            {
                DestroyCachedObject(entry?.CachedUnityObject);
                entry?.Invalidate();
            }
