...
namespace FUSE.Loading
{
    ...
    internal static class FuseSpatialTrackConflictDetector
    {
        ...
        {
            return IsExpectedLayeringInOrder(existing, later) || IsExpectedLayeringInOrder(later, existing);
        }

        private static bool IsExpectedLayeringInOrder(TrackFootprint existing, TrackFootprint later)
        {
