    ...
    public static class FuseSettings
    {
        ...
        public static void Load(UnityModManager.ModEntry modEntry)
        {
            ...
            try
            {
                ...
                GraceMinimumDays = NormalizeGraceMinimumDays(
                    ReadInt(settings, "GraceMinimumDays", DefaultGraceMinimumDays));
                GraceMultiplier = NormalizeGraceMultiplier(
        ...
        {
            GraceMinimumDays = NormalizeGraceMinimumDays(value);
            SaveUserOverride(nameof(GraceMinimumDays), GraceMinimumDays);
            FuseLog.Info($"FUSE legacy gameplay setting changed: {nameof(GraceMinimumDays)}={GraceMinimumDays}.");
        }

        public static void SetGraceMultiplier(int value)
        {
            GraceMultiplier = NormalizeGraceMultiplier(value);
            SaveUserOverride(nameof(GraceMultiplier), GraceMultiplier);
            FuseLog.Info($"FUSE legacy gameplay setting changed: {nameof(GraceMultiplier)}={GraceMultiplier}.");
        }

        public static void SetGraceAddedDays(int value)
        {
            GraceAddedDays = NormalizeGraceAddedDays(value);
            SaveUserOverride(nameof(GraceAddedDays), GraceAddedDays);
        ...
        internal static int NormalizeGraceMultiplier(int value)
        {
            return Math.Max(1, value);
        }

        internal static int NormalizeGraceAddedDays(int value)
        {
            return Math.Max(0, value);
        }
