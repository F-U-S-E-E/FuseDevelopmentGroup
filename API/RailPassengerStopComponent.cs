...
namespace RAIL.API
{
    public sealed class RailPassengerStopComponent : IndustryComponent, IRailAppliedComponent
    {
        ...
        public RailPassengerBranch[] BranchDefinitions { get; set; } = Array.Empty<RailPassengerBranch>();
        ...
        public void OnRailDefinitionApplied()
        {
        ...
        private List<RailPassengerBranch> BuildBranchDefinitions()
        {
            var branchDefinitions = BranchDefinitions != null
                ? new List<RailPassengerBranch>(BranchDefinitions.Where(definition => definition != null))
                : new List<RailPassengerBranch>();
            ...
            if (!string.IsNullOrWhiteSpace(Branch))
            {
                foreach (var branchName in Branch.Split(new[] { ':' }, StringSplitOptions.RemoveEmptyEntries))
                {
                    ...
                    branchDefinitions.Add(new RailPassengerBranch
                    {
                        Branch = branchName,
