...
namespace RAIL.API
{
    internal sealed class RailPrefabSanitizerResult
    {
        ...
        public void Log(string context)
        {
            if (Actions.Count > 0)
            {
                RailLog.Info($"{context} sanitizer actions: {string.Join("; ", Actions.ToArray())}");
            }

            foreach (var warning in Warnings)
            {
                RailLog.Warning($"{context} sanitizer warning: {warning}");
            }
        }
    }

    internal static class RailPrefabSanitizer
    {
        ...
        public static RailPrefabSanitizerResult SanitizeSceneClone(GameObject root, string id)
        {
            var result = new RailPrefabSanitizerResult();
        ...
        public static RailPrefabSanitizerResult SanitizeLoader(GameObject root, string id, Industry industry)
        {
            var result = new RailPrefabSanitizerResult();
        ...
        public static RailPrefabSanitizerResult SanitizeStation(
            GameObject root,
            string id,
        ...
        public static RailPrefabSanitizerResult SanitizeTurntable(GameObject root, string id, Turntable turntable)
        {
            var result = new RailPrefabSanitizerResult();
        ...
        public static RailPrefabSanitizerResult ValidateLoaderPostBind(GameObject root, string id, Industry expectedIndustry)
        {
            var result = new RailPrefabSanitizerResult();
            if (!ValidateRoot(root, "loader", id, result))
            {
        ...
        public static RailPrefabSanitizerResult ValidateStationPostBind(
            GameObject root,
            string id,
            StationAgent stationAgent,
            Area expectedArea,
        ...
        public static RailPrefabSanitizerResult ValidateTurntablePostBind(GameObject root, string id, Turntable turntable)
        {
            var result = new RailPrefabSanitizerResult();
            if (!ValidateRoot(root, "turntable", id, result))
            {
        ...
        public static RailPrefabSanitizerResult ValidateSceneClonePostBind(GameObject root, string id)
        {
            var result = new RailPrefabSanitizerResult();
            if (!ValidateRoot(root, "scene clone", id, result))
            {
        ...
        private static bool ValidateRoot(GameObject root, string kind, string id, RailPrefabSanitizerResult result)
        {
            if (root != null)
            {
                return true;
        ...
        private static void ReplaceGlobalObjectIds(GameObject root, string prefix, RailPrefabSanitizerResult result)
        {
        ...
        private static void DisableTrackMarkers(GameObject root, RailPrefabSanitizerResult result)
        {
        ...
        private static void ClearCachedIdentityFields(GameObject root, RailPrefabSanitizerResult result)
        {
            var resetCount = 0;
        ...
        private static int ClearPrivateReferenceField(Component component, string fieldName)
        {
            ...
            {
                RailLog.Warning($"RAIL prefab sanitizer could not clear field '{component.GetType().FullName}.{fieldName}': {ex.Message}");
                return 0;
            }
        }

        private static void RelinkLoaderIndustry(GameObject root, Industry industry, RailPrefabSanitizerResult result)
        {
            if (industry == null)
            {
        ...
        private static void RelinkStationAgent(
            ...
            Area area,
            PassengerStop passengerStop,
            RailPrefabSanitizerResult result)
        {
            if (stationAgent == null)
            {
        ...
        private static void RelinkTurntableController(GameObject root, Turntable turntable, RailPrefabSanitizerResult result)
        {
            if (turntable == null)
            {
        ...
        private static void ForceLodZero(GameObject root, RailPrefabSanitizerResult result)
        {
        ...
        private static void ValidateRequiredComponent<T>(GameObject root, string label, RailPrefabSanitizerResult result)
            where T : Component
        {
        ...
        private static void ValidateRendererPresence(GameObject root, string label, RailPrefabSanitizerResult result)
        {
        ...
        private static void ValidateSaneIdentityAndTransform(GameObject root, string kind, string id, RailPrefabSanitizerResult result)
        {
